# -*- coding: utf-8 -*-
"""Copy of Research.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/16D2YTFAg4pMpyF-yS3Sj-aXGuN9cvs2a
"""
...
## DEMOGRAPHIC DATA
demographics_url = 'https://wwwn.cdc.gov/Nchs/Nhanes/2021-2022/DEMO_L.XPT'
...
## BLOOD TEST DATA
blood_test_url = 'https://wwwn.cdc.gov/Nchs/Nhanes/2021-2022/CBC_L.XPT'
...
## BLOOD PRESSURE DATA
BP_url = 'https://wwwn.cdc.gov/Nchs/Nhanes/2021-2022/BPXO_L.XPT'
BP = download_xpt(BP_url, 'BP.xpt')

## CHOLESTROL TOTAL DATA
cholestrol_url = 'https://wwwn.cdc.gov/Nchs/Nhanes/2021-2022/TCHOL_L.XPT'
...
## GLUCOSE DATA
glucose_url = 'https://wwwn.cdc.gov/Nchs/Nhanes/2021-2022/GLU_L.XPT'
glucose = download_xpt(glucose_url, 'glucose.xpt')
glucose.rename(columns={'LBXGLU': 'Fasting Glucose (mg/dL)'}, inplace=True)

#LEAD
lead_url = 'https://wwwn.cdc.gov/Nchs/Nhanes/2021-2022/PBCD_L.XPT'
lead = download_xpt(lead_url, 'lead.xpt')
lead_columns = lead.columns

# Steroid Hormones
steroidhormones_url = 'https://wwwn.cdc.gov/Nchs/Nhanes/2021-2022/TST_L.XPT'
...
#Acid Glycoprotein
acidGlycoprotein_url = 'https://wwwn.cdc.gov/Nchs/Nhanes/2021-2022/AGP_L.XPT'
acidGlycoprotein = download_xpt(acidGlycoprotein_url, 'acidGlycoprotein.xpt')

#Cholesterol – High-Density Lipoprotein
cholesterolHighDensity_url = 'https://wwwn.cdc.gov/Nchs/Nhanes/2021-2022/HDL_L.XPT'
cholesterolHighDensity = download_xpt(cholesterolHighDensity_url, 'cholesterolHighDensity.xpt')


#Ferritin
ferritin_url = 'https://wwwn.cdc.gov/Nchs/Nhanes/2021-2022/FERTIN_L.XPT'
ferritin = download_xpt(ferritin_url, 'ferritin.xpt')

#Folate - RBC
folate_url = 'https://wwwn.cdc.gov/Nchs/Nhanes/2021-2022/FOLATE_L.XPT'
folate = download_xpt(folate_url, 'folate.xpt')

#Glycohemoglobin
glycohemoglobin_url = 'https://wwwn.cdc.gov/Nchs/Nhanes/2021-2022/GHB_L.XPT'
glycohemoglobin = download_xpt(glycohemoglobin_url, 'glycohemoglobin.xpt')


#Hepatitis A
hepatitisA_url = 'https://wwwn.cdc.gov/Nchs/Nhanes/2021-2022/HEPA_L.XPT'
hepatitisA = download_xpt(hepatitisA_url, 'hepatitisA.xpt')


#Hepatitis B Surface Antibody
hepatitisB_url = 'https://wwwn.cdc.gov/Nchs/Nhanes/2021-2022/HEPB_S_L.XPT'
hepatitisB = download_xpt(hepatitisB_url, 'hepatitisB.xpt')

#High-Sensitivity C-Reactive Protein
creactiveProtein_url = 'https://wwwn.cdc.gov/Nchs/Nhanes/2021-2022/HSCRP_L.XPT'
creactiveProtein = download_xpt(creactiveProtein_url, 'creactiveProtein.xpt')

#Insulin
insulin_url = 'https://wwwn.cdc.gov/Nchs/Nhanes/2021-2022/INS_L.XPT'
insulin = download_xpt(insulin_url, 'insulin.xpt')

#Mercury: Inorganic, Ethyl, and Methyl - Blood
mercury_url = 'https://wwwn.cdc.gov/Nchs/Nhanes/2021-2022/IHGEM_L.XPT'
mercury = download_xpt(mercury_url, 'mercury.xpt')

#Serum
serum_url = 'https://wwwn.cdc.gov/Nchs/Nhanes/2021-2022/FOLFMS_L.XPT'
serum = download_xpt(serum_url, 'serum.xpt')

#Transferrin Receptor
transferrinReceptor_url = 'https://wwwn.cdc.gov/Nchs/Nhanes/2021-2022/TFR_L.XPT'
transferrinReceptor = download_xpt(transferrinReceptor_url, 'transferrinReceptor.xpt')

#Vitamin D
vitaminD_url = 'https://wwwn.cdc.gov/Nchs/Nhanes/2021-2022/VID_L.XPT'
...
correlation_columns = [ 'Age in years at screening'] + list(rename_dict.values())[0:30]
# Filter the DataFrame to include only the selected columns
correlation_data = merged_dfFinal[correlation_columns]

# Drop rows with missing values
correlation_data = correlation_data.dropna()

# Get the correlation of all features with 'Age in years at screening'
age_correlation = correlation_matrix['Age in years at screening'].sort_values(ascending=False)

# Print the sorted correlation with 'Age in years at screening'
...
# I want to pull out all of the values in the rename_dict dictionary object and make them into a list called selected_vars
#selected_vars = list(rename_dict.values())
...
# Now follow this process with a random forest model
...
print(f"Random Forest â€“ Root Mean Squared Error: {rmse_rf}")
print(f"Random Forest â€“ R-squared: {r2_rf}")